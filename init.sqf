...
addMissionEventHandler ["HandleDisconnect",{_this execVM "\life_server\Functions\Systems\fn_clientDisconnect.sqf"; false;}];
...
[] execVM "\life_server\s_fps.sqf";

[] spawn DB_fnc_initVehicle;
[] spawn DB_fnc_initWanted;
[] spawn DB_fnc_initFriends;
