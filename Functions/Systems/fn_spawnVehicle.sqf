...
*/
private["_vid","_sp","_pid","_query","_sql","_vehicle","_nearVehicles","_name","_side","_tickTime","_dir","_servIndex","_allHitpoints","_hitpoints","_actualHitpoints"];
...
_query = format["SELECT id, side, classname, type, pid, alive, active, plate, color, inventory, pos, hitpoint, fuel, damage FROM vehicles WHERE id='%1' AND pid='%2'",_vid,_pid];
...
_vehicle setDamage (_vInfo select 13);
